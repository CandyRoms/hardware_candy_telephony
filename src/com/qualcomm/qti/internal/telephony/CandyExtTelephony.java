...
public class CandyExtTelephony extends IExtTelephony.Stub {
    ...
    private static CandyExtTelephony sInstance;
    ...
    public static CandyExtTelephony getInstance(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
        if (sInstance == null) {
            sInstance = new CandyExtTelephony(context, phones, commandsInterfaces);
        }

        return sInstance;
    }

    private CandyExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
